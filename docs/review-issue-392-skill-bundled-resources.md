...
- [x] `docs/architecture/file-formats.md` に Skill 付属リソース節を追加
- [x] `docs/concepts/components.md` / `deployment.md` の例示更新
- [x] スキャン: 任意名フォルダ内 `SKILL.md` の非二重検出テスト
- [x] デプロイ: 同構造コピー・stale 掃除・付属 md の frontmatter 非改変テスト
- [x] #393 / Cursor 既知制限を仕様または Issue 本文に明記
