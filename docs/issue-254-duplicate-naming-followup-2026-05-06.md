...
| Model rename | #258, #269-#270 | 実装 | `InstalledModel` / `MarketplacesModel` alias を公開し、`Screen` enum の外部境界で利用した |
...
| #258 Model rename | `InstalledModel` / `MarketplacesModel` alias を公開境界へ導入 |
