...
Cursor は階層デプロイではなく、`flatten_name(plugin, original)` によるフラット配置を使う。
...
展開先（Skills）:
Cursor (Personal): ~/.cursor/skills/code-formatter_formatter-skill/SKILL.md
Cursor (Project):  .cursor/skills/code-formatter_formatter-skill/SKILL.md
